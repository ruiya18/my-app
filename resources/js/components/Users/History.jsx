  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="space-y-6 mb-6">
                ...
                >
                  ...
                  <div className="w-1/3 bg-gray-100 flex items-center justify-center p-4">
                    {booking.product_image ? (
                      <img
                        src={
                          booking.product_image.startsWith("http")
                            ? booking.product_image
                  ...
                  <div className="w-2/3 p-4 space-y-2">
                    <h3 className="text-xl font-bold">{booking.product_name}</h3>
                    <p>
                      <strong>Product ID:</strong> {booking.product_id}
                    </p>
                    <p>
              ...
              {booking.reservation_id && (
                <>
                    ...
                    {booking.reserve_date ? booking.reserve_date : "-"}
                    </p>
                    <p>
                    <strong>Reserve Time:</strong>{" "}
                    {booking.reserve_time ? booking.reserve_time : "-"}
                    </p>
                </>
                )}
                    ...
                    <p>
                      ...
                      {booking.checkout_at
                        ? new Date(booking.checkout_at).toLocaleString()
                        : "-"}
                    </p>
                    <p>
                      <strong>Checkin At:</strong>{" "}
                      {booking.checkin_at
                        ? new Date(booking.checkin_at).toLocaleString()
                        : "-"}
                    </p>
                    {booking.reservation_id && (
        ...
        <h3 className="text-xl font-semibold mt-10 mb-4">Reservations</h3>
        {reservations.length === 0 ? (
          ...
          <div>
                ...
                >
                  ...
                  <div className="w-1/3 bg-gray-100 flex items-center justify-center p-4">
                    {res.product_image ? (
                      <img
                        src={
                            res.product_image.startsWith("http")
                            ? res.product_image
                  ...
                  {/* Details */}
                  <div className="w-2/3 p-4 space-y-2">
                    <h3 className="text-xl font-bold">{res.product_name}</h3>
                    <p>
                      <strong>Product ID:</strong> {res.product_id}
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>Reserve Date:</strong> {res.reserve_date}
                    </p>
                    <p>
                      <strong>Reserve Time:</strong> {res.reserve_time}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="flex justify-center space-x-2">
              ...
              <span>
                Page {reservationPage} of {totalReservationPages}
              </span>
              <button
