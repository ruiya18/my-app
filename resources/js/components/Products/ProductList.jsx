      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        {Object.keys(grouped).length > 0 ? (
          Object.keys(grouped).map((outlet) => {
            ...
            const totalPages = Math.ceil(grouped[outlet].length / ITEMS_PER_PAGE);
            const pageProducts = grouped[outlet].slice(startIndex, endIndex);
