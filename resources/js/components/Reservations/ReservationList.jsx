                ...
                <table className="min-w-full table-auto border-collapse">
                  ...
                  <tbody>
                    {groupedByOutlet[outlet].map((res) => {
                      ...
                      const isPastDate = isReservationDatePast(res.reserve_date);
                      const isEditDisabled = 
                        res.status === "pending" && isPastDate || 
                        (res.status === "accepted" && 
                      ...
                      const getEditDisabledReason = () => {
                        ...
                        if (res.status === "pending" && isPastDate) {
                          return "Cannot edit past pending reservations";
                        }
                        return "";
                      };
                      
                      const disabledReason = getEditDisabledReason();
